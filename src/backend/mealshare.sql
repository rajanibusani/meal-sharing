...
INSERT INTO meals (id,title, description,location, `when`, max_reservations, price)
 ...
 (2,'Chicken stew with appam','Chicken stew with south indian pancake', 'Bagsværd', '2021-05-29 09:00:00', 25, 75),
 (3,'Mexican Shrimp Tacos','Crispy cheesy shrimp tacos and homemade salsa', 'Brøndby', '2021-06-14 18:30:00', 20, 125), 
 (4,'Baklava and Sfouf Cake','Baklava which is pastry layered with chopped nuts and sweetened with syrup, Sfouf Cake which is almond-semolina cake', 'Hedehusene', '2021-05-30 17:00:00', 15, 90),
...
INSERT INTO reservations (id,number_of_guests,meal_id,contact_phonenumber,contact_name,contact_email)
VALUES(1,4,1,'12 43 65 78', 'Mette','mette@gmail.com'),
  (2,5,3,'28 74 93 74', 'Chris','chris@gmail.com')
(3,6,2,'98 34 73 74', 'katie','katie@gmail.com'),
(4,5,6,'22 72 23 14', 'Marianna','mas@gmail.com'),
(5,8,3,'18 14 33 24', 'Daniel','daniel@gmail.com'),
(6,7,3,'21 12 83 14', 'Lucy','lucy@gmail.com'),
(7,7,5,'18 14 23 24', 'Jade Parker','jade@gmail.com') ; 
